    ...
    suspend fun createAlbum(
        ...
        try {
            ...
            val block = releasePublishBlockRepository.create(
                releaseId = releaseId,
                magnet = "",  // Keep magnet empty in the block
                title = title,
                artist = artist,
            ...
            if (block != null) {
                try {
                    ...
                    val infoHash = if (magnet.isNotEmpty()) {
                    ...
                    database.dao.insert(
                        AlbumEntity(
                            ...
                            magnet = magnet,  // Store the actual magnet link locally
        ...
        suspend fun refreshCache() {
            ...
            releaseBlocks.forEach {
                ...
                val magnet = if (it.magnet != null && it.magnet.isNotEmpty()) {
                    it.magnet
                } else {
                    "access_restricted"
                }
                ...
                val infoHash = if (magnet != "access_restricted") {
                    try {
                        TorrentEngine.magnetToInfoHash(magnet)
                    } catch (e: Exception) {
