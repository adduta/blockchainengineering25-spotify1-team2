...
class AlbumRepositoryTest {
    ...
    @Test
    fun `test getAlbumsFromCache returns all albums for BASIC user when not access restricted`() =
        runTest {
            val albumEntities =
                listOf(
                    AlbumEntity(
    ...
    @Test
    fun `test getAlbumsFromCache filters out access restricted albums for BASIC user`() =
        runTest {
            val albumEntities =
                listOf(
                    AlbumEntity(
    ...
    @Test
    fun `test getAlbumsFromCache includes access restricted albums for PRO user`() =
        runTest {
            val albumEntities =
                listOf(
                    AlbumEntity(
    ...
    @Test
    fun `test getAlbumsFromCache includes access restricted albums for past delay period`() =
        runTest {
            val albumEntities =
                listOf(
                    AlbumEntity(
    ...
    @Test
    fun `test getAlbumsFromCache includes exclusive albums for ULTIMATE user`() =
        runTest {
            val albumEntities =
                listOf(
                    AlbumEntity(
