...
class ReleaseRequestHandlerTest {
    ...
    fun `test handleRequest with non-existent release`() = runBlocking {
        // Arrange
    ...
    fun `test handleRequest for PRO user`() = runBlocking {
        // Arrange
    ...
    fun `test handleRequest for BASIC user with old release`() = runBlocking {
        // Arrange
        val releaseId = "test-release"
        val magnetLink = "magnet:?xt=urn:btih:test"
        val request = ReleaseRequestMessage(
    ...
    fun `test handleRequest for BASIC user with new release`() = runBlocking {
        // Arrange
        val releaseId = "test-release"
        val magnetLink = "magnet:?xt=urn:btih:test"
        val request = ReleaseRequestMessage(
    ...
    fun `test handleRequest with exactly 7 days old release`() = runBlocking {
        // Arrange
        val releaseId = "test-release"
        val magnetLink = "magnet:?xt=urn:btih:test"
        val request = ReleaseRequestMessage(
