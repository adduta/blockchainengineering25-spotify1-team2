...
class ProfileScreenViewModelTest {
    ...
    @Test
    fun `test loadTierStatus sets BASIC tier when no valid tier blocks`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
    ...
    @Test
    fun `test loadTierStatus sets PRO tier when user is PRO`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
            every { userTierVerifier.isUltimateUser(any()) } returns false
    ...
    @Test
    fun `test loadTierStatus sets ULTIMATE tier when user is ULTIMATE`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
    ...
    @Test
    fun `test upgradeToPro updates tier and validUntil on success`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
    ...
    @Test
    fun `test upgradeToPro does not update tier on failure`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
    ...
    @Test
    fun `test upgradeToUltimate updates tier and validUntil on success`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
    ...
    @Test
    fun `test upgradeToUltimate does not update tier on failure`() =
        runTest {
            every { musicCommunity.publicKeyHex() } returns publicKey
